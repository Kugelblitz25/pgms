...
def test_inference_no_k_value():
    data: dict[str, Any] = {
        "VariablesCount": 2,
        "Cliques and Potentials": [{"cliques": [0, 1], "potentials": [1, 2, 3, 4]}],
    }
...
def test_triangulation_with_complete_graph():
    data: dict[str, Any] = {
        ...
        "Cliques and Potentials": [
            {"cliques": [0, 1, 2], "potentials": [1, 2, 3, 4, 5, 6, 7, 8]}
        ],
    }
...
def test_multiple_potentials_same_variables():
    data: dict[str, Any] = {
        ...
        "Cliques and Potentials": [
            ...
            {"cliques": [0, 1], "potentials": [2, 3, 4, 5]},
        ],
    }
...
def test_disconnected_components():
    data: dict[str, Any] = {
        ...
        "Cliques and Potentials": [
            {"cliques": [0, 1], "potentials": [1, 2, 3, 4]},
            {"cliques": [2, 3], "potentials": [1, 2, 3, 4]},
        ],
    }
...
def test_zero_potentials():
    data: dict[str, Any] = {
        "VariablesCount": 2,
        "Cliques and Potentials": [{"cliques": [0, 1], "potentials": [0, 0, 1, 2]}],
    }
